...
This document presents results of running the recurring transactions model on the raw transactions in "Export Data All - HJ.csv".
...
```{r, echo=FALSE}
data.raw <- load_data('C:/Users/akulkarni/Documents/Yodlee/Data driven app/HJ/Export Data All - HJ.csv')
```
